...
<docs-code-multifile
  path="adev/content/examples/accessibility/src/app/app.component.ts"
  preview>
  <docs-code
    path="adev/content/examples/accessibility/src/app/progress-bar.component.ts"
    linenums
    highlight="[12, 20]"/>
  <docs-code
    path="adev/content/examples/accessibility/src/app/app.component.html"
    linenums
    highlight="[8, 9]"/>
</docs-code-multifile>
