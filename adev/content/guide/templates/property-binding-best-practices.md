...
<docs-code header="src/app/app.component.html" path="adev/content/examples/property-binding/src/app/app.component.html" visibleRegion="model-property-binding"/>

Confirm this expectation by looking in the `ItemDetailComponent` where the `@Input()` type is `string`:

<docs-code header="src/app/item-detail.component.ts (setting the @Input() type)" path="adev/content/examples/property-binding/src/app/item-detail.component.ts" visibleRegion="input-type"/>
...
<docs-code header="src/app/app.component.ts" path="adev/content/examples/property-binding/src/app/app.component.ts" visibleRegion="parent-data-type"/>
...
<docs-code header="src/app/app.component.html" path="adev/content/examples/property-binding/src/app/app.component.html" visibleRegion="pass-object"/>

In the `ItemListComponent` the `@Input()`, `items`, has a type of `Item[]`.

<docs-code header="src/app/item-list.component.ts" path="adev/content/examples/property-binding/src/app/item-list.component.ts" visibleRegion="item-input"/>

Notice that `Item` is an object and it has two properties, an `id` and a `name`.

<docs-code header="src/app/item.ts" path="adev/content/examples/property-binding/src/app/item.ts" visibleRegion="item-class"/>
...
<docs-code header="src/app.component.ts" path="adev/content/examples/property-binding/src/app/app.component.ts" visibleRegion="pass-object"/>
