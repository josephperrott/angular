...
<docs-code header="src/app/app.component.html" path="adev/content/examples/two-way-binding/src/app/app.component.html" visibleRegion="two-way-syntax"/>
...
<docs-code header="src/app/sizer.component.ts" path="adev/content/examples/two-way-binding/src/app/sizer/sizer.component.ts" visibleRegion="sizer-component"/>
...
<docs-code header="src/app/sizer.component.html" path="adev/content/examples/two-way-binding/src/app/sizer/sizer.component.html"/>

In the `AppComponent` template, `fontSizePx` is two-way bound to the `SizerComponent`.

<docs-code header="src/app/app.component.html" path="adev/content/examples/two-way-binding/src/app/app.component.html" visibleRegion="two-way-1"/>

In the `AppComponent`, `fontSizePx` establishes the initial `SizerComponent.size` value by setting the value to `16`.

<docs-code header="src/app/app.component.ts" path="adev/content/examples/two-way-binding/src/app/app.component.ts" visibleRegion="font-size"/>
...
<docs-code header="src/app/app.component.html (expanded)" path="adev/content/examples/two-way-binding/src/app/app.component.html" visibleRegion="two-way-2"/>
