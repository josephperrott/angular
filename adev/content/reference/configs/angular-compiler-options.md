...
<docs-code header="tsconfig.json" path="adev/content/examples/angular-compiler-options/tsconfig.json" visibleRegion="angular-compiler-options"/>
...
<docs-code header="tsconfig.app.json" path="adev/content/examples/angular-compiler-options/tsconfig.app.json" visibleRegion="angular-compiler-options-app"/>
