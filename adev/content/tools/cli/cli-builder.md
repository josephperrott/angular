...
<docs-code header="src/my-builder.ts (builder skeleton)" path="adev/content/examples/cli-builder/src/my-builder.ts" visibleRegion="builder-skeleton"/>
...
<docs-code header="src/my-builder.ts (builder)" path="adev/content/examples/cli-builder/src/my-builder.ts" visibleRegion="builder"/>
...
<docs-code header="src/my-builder.ts (handling output)" path="adev/content/examples/cli-builder/src/my-builder.ts" visibleRegion="handling-output"/>
...
<docs-code header="src/my-builder.ts (progress reporting)" path="adev/content/examples/cli-builder/src/my-builder.ts" visibleRegion="progress-reporting"/>
...
<docs-code header="src/my-builder.ts (report status)" path="adev/content/examples/cli-builder/src/my-builder.ts" visibleRegion="report-status"/>
...
<docs-code header="src/my-builder.spec.ts" path="adev/content/examples/cli-builder/src/my-builder.spec.ts"/>
