...
1. In `src/app/housing.service.ts`, make the following changes:
    ...
    1. Update the `getAllHousingLocations` function to make a call to the web server you configured.
        ...
        <docs-code header="" path="adev/content/tutorials/first-app/steps/14-http/src-final/app/housing.service.ts" visibleLines="[12,14]"/>
    ...
    1. Update the `getHousingLocationsById` function to make a call to the web server you configured.
        ...
        <docs-code header="" path="adev/content/tutorials/first-app/steps/14-http/src-final/app/housing.service.ts" visibleLines="[16,19]"/>

    1. Once all the updates are complete, your updated service should match the following code.

        <docs-code header="Final version of housing.service.ts" path="adev/content/tutorials/first-app/steps/14-http/src-final/app/housing.service.ts"/>
...
1. In `src/app/home/home.component.ts`, update the `constructor` to use the new asynchronous version of the `getAllHousingLocations` method.
    ...
    <docs-code header="" path="adev/content/tutorials/first-app/steps/14-http/src-final/app/home/home.component.ts" visibleLines="[36,41]"/>
...
1. In `src/app/details/details.component.ts`, update the `constructor` to use the new asynchronous version of the `getHousingLocationById` method.
    ...
    <docs-code header="" path="adev/content/tutorials/first-app/steps/14-http/src-final/app/details/details.component.ts" visibleLines="[61,66]"/>
