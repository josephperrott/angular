...
import {buildFixupCommitsCommand, handleFixupCommitscommand} from './amend-commit/cli';
...
export function buildPrParser(localYargs: yargs.Argv) {
  return localYargs.help()
      ...
      .command(
          'fixup-commits <pr-number>', 'Allow for amending commits in sequence for a pr',
          buildFixupCommitsCommand, handleFixupCommitscommand);
}
